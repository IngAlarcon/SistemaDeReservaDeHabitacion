                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  active has-sub">
                            ...
                            <ul class="submenu active">
                               <form action="SvCrearReservas" method="GET">  
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Mi Registro de Huespedes</h4>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                       ...
                                       <%
                                        ...
                                        <%
                                            ...
                                            String verNHuesped;
                                            String verAHuesped;
                                            String verCheck_in= formato.format(res.getCheck_in());
                                            String verCheck_out= formato.format(res.getCheck_out());
                                            String verFechaReserva= formato.format(res.getFecha_reserva());
                                            
                                                String verHabitacion;
                                                int verHabitacionPiso;
                                                int verHabitacionNum;
                                            
                                            try{
                                                
                                                 verNHuesped = res.getReservaHuesped().getNombre();
                                                 verAHuesped = res.getReservaHuesped().getApellido();
                                                
                                                verHabitacion =res.getTipoHabitacion().getTematica();
                                                verHabitacionPiso =res.getTipoHabitacion().getPiso();
                                                verHabitacionNum =res.getTipoHabitacion().getNum_habitacion();                        
                                            ...
                                            int verCantidadH= res.getCantidad_personas();
                                            String verUsuariod= res.getReservaUsuario().getNombre_usuario();
                                            double verPrecioTotal= res.getPrecio_total();
                                            int verId = res.getId_reserva();
                                            ...
                                            %>                                   
                                                    ...
                                                    <td class="text-bold-500"><%=verNHuesped%> <%=verAHuesped%></td>
                                                    
                                                    <td ><%=verCheck_in%></td>
                                                    
                                                    <td><%=verCheck_out%></td>
                                                    
                                                    <td class="text-bold-500"><%=verHabitacion%> - Piso: <%=verHabitacionPiso%> - N° hab. <%=verHabitacionNum%>  </td>
                                                    
                                                    <td><%=verCantidadH%> Personas</td>
                                                    <td><%=verPrecioTotal%></td>
                                                    
                                                     <td><%=verUsuariod%> </td>
                                                    <td><%=verFechaReserva%></td>
