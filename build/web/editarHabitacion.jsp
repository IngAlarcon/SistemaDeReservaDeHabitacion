                           ...
                           <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Editar datos de habitacion</h4>
                                </div>
                                ...
                                <%
                                    ...
                                    Habitacion editHabitacion = (Habitacion) misession.getAttribute("habitacionEncontrada");
                                    
                                     
                                     int numTipoHabitacion = editHabitacion.getTipo_habitacion();  
                                     
                                      String nombreTipoHabitacion= control.habitacionIntAString(numTipoHabitacion);
                                              ...
                                              <form action="SvEditarHabitacion" method="POST">  
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="first-name-icon">Piso</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="numeroPisoEdit" value="<%=editHabitacion.getPiso()%>" placeholder="Numero de piso" id="first-name-icon">
                                                     ...
                                                     <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="first-name-icon">Numero de la habitacion</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="numeroHabitacionEdit" value="<%=editHabitacion.getNum_habitacion()%>" placeholder="Numero...." id="first-name-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <label for="email-id-icon">Tematica de la habitacion</label>
                                                            <div class="input-group mb-3">
                                                                <label class="input-group-text"  for="inputGroupSelect01">Opciones</label>
                                                                <select class="form-select" name="tematicaHabitacionEdit" id="inputGroupSelect01">
                                                                    <option selected="<%=editHabitacion.getTematica()%>"><%=editHabitacion.getTematica()%></option>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            <label for="email-id-icon">Tipo de habitacion (Cantidad de personas permitidas)    </label>
                                                            <div class="input-group mb-3">
                                                                <label class="input-group-text"  for="inputGroupSelect01">Opciones</label>
                                                                <select class="form-select" name="tipoHabitacionEdit"  id="inputGroupSelect01">
                                                                    <option value="<%=numTipoHabitacion %>"><%=nombreTipoHabitacion%></option>
                                                                    <option value="1">Single(1 sola persona) </option>
                                                                    <option value="2">Doble(2 personas como máximo)</option>
                                                                    <option value="3">Triple(3 personas como máximo)</option>
                                                                    <option value="4">Múltiple( hasta 6 personas como maximo)</option>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="password-id-icon">Precio por Noche</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="precioHabitacionEdit" value="<%=editHabitacion.getPrecio_noche()%>" placeholder="Precio..">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                     ...
                                                     <input type="hidden" name="idEdit" value="<%= editHabitacion.getId_habitacion()%>">
