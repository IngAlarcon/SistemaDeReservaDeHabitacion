                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Mi Registro de Empleados</h4>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                       ...
                                       <%
                                        ...
                                        <%
                                            ...
                                            String verNombreEmpleado= emple.getNombre();
                                            String verApellidoEmpleado= emple.getApellido();
                                            String verDniEmpleado= emple.getDni();
                                            String verFechaNEmpledo =formato.format(emple.getFecha_nac());
                                            String verDireccionEmpleado= emple.getDireccion();
                                            String verCargoEmpleado= emple.getCargo();
                                            int verId = emple.getId_persona();
                                            ...
                                            %>                                   
                                                    ...
                                                    <td class="text-bold-500"><%=verNombreEmpleado%></td>
                                                    
                                                    <td ><%=verApellidoEmpleado%></td>
                                                    
                                                    <td><%=verDniEmpleado%></td>
                                                    
                                                    <td class="text-bold-500"><%=verFechaNEmpledo%></td>
                                                    
                                                    <td><%=verDireccionEmpleado%></td>
                                                    <td><%=verCargoEmpleado%></td>
