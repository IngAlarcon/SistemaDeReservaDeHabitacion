                           ...
                           <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Crear nueva habitacion</h4>
                                </div>
                                              ...
                                              <form action="SvCrearHabitacion" method="POST">  
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="numeroPiso" placeholder="Numero de piso" id="first-name-icon">
                                                     ...
                                                     <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="numeroHabitacion" placeholder="Numero...." id="first-name-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select class="form-select" name="tematicaHabitacion" id="inputGroupSelect01">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                <label class="input-group-text"  for="inputGroupSelect01">Opciones</label>
                                                                <select class="form-select" name="tipoHabitacion" id="inputGroupSelect01">
                                                                    <option selected="">Seleccionar...</option>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="precioHabitacion" placeholder="Precio.." id="password-id-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
