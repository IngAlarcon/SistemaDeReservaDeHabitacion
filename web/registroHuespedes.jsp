                                    ...
                                    <div class="table-responsive">
                                       ...
                                       <%
                                        ...
                                        <%
                                            ...
                                            String verNombreHuesped= huesp.getNombre();
                                            String verApellidoHuesped= huesp.getApellido();
                                            String verDniHuesped= huesp.getDni();
                                            String verFechaNHuesped =formato.format(huesp.getFecha_nac());
                                            String verDireccionHuesped= huesp.getDireccion();
                                            String verProfesionHuesped= huesp.getProfesion();
                                            int verId = huesp.getId_persona();
                                            ...
                                            %>                                   
                                                    ...
                                                    <td class="text-bold-500"><%=verNombreHuesped%></td>
                                                    
                                                    <td ><%=verApellidoHuesped%></td>
                                                    
                                                    <td><%=verDniHuesped%></td>
                                                    
                                                    <td class="text-bold-500"><%=verFechaNHuesped%></td>
                                                    
                                                    <td><%=verDireccionHuesped%></td>
                                                    <td><%=verProfesionHuesped%></td>
