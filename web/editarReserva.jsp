                           ...
                           <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Editar datos de reserva</h4>
                                        ...
                                        <form class="form form-vertical" action="SvCrearReserva" method="POST">
                                            <div class="form-body">
                                                ...
                                                <%
                                                  ...
                                                  Reserva reservaEncontrada = (Reserva) request.getSession().getAttribute("reservaEncontrada");

                                                  String huespedNombre =  reservaEncontrada.getReservaHuesped().getNombre();
                                                  String huespedApellido = reservaEncontrada.getReservaHuesped().getApellido();
                                                  String huespedDni = reservaEncontrada.getReservaHuesped().getDni();
                                                  
                                                    String fechaReservaString = control.convertirFechaStringInput(reservaEncontrada.getFecha_reserva());
                                                    String fechaCheck_inString = control.convertirFechaStringInput(reservaEncontrada.getCheck_in());
                                                    String fechaCheck_outString = control.convertirFechaStringInput(reservaEncontrada.getCheck_out());
                                                  
                                                  
                                                  String tematicaEncontrada = reservaEncontrada.getTipoHabitacion().getTematica();
                                                  String tipoEncontrada = Integer.toString(reservaEncontrada.getTipoHabitacion().getTipo_habitacion());
                                                  String precioEncontrada = Double.toString(reservaEncontrada.getTipoHabitacion().getPrecio_noche());
                                                  
                                                
                                                   %>
                                                   
                                                  <input type="hidden" name="editarResevaId" value="<%=reservaEncontrada.getId_reserva()%>"> 
                                                   ...
                                                   <div class="form-group has-icon-left">
                                                      <label for="email-id-icon">Huesped a relaizar la reserva</label>
                                                        <div class="input-group mb-3">
                                                          ...
                                                          <select class="form-select" name="huespedReserva" id="inputGroupSelect01">
                                                              <option value="<%=reservaEncontrada.getReservaHuesped().getId_persona()%>"><%=huespedNombre%> <%=huespedApellido%> - Dni: <%=huespedDni%></option>
                                                               <%
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="fechaCheck_in" value="<%=fechaCheck_inString%>" placeholder="" id="first-name-icon">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="fechaCheck_out" value="<%=fechaCheck_outString%>" placeholder="" id="first-name-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                     ...
                                                     <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="fechaReserva" placeholder="" value="<%=fechaReservaString%>" id="first-name-icon">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                      ...
                                                      <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select class="form-select" name="cantidadReserva" id="inputGroupSelect01">
                                                                    <option value="<%=reservaEncontrada.getCantidad_personas()%>"> <%=reservaEncontrada.getCantidad_personas()%> Persona</option>
                                                      ...
                                                      <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <select class="form-select" name="habitacionReserva" id="itemHabitacion">
                                                                    <option value="<%=reservaEncontrada.getTipoHabitacion().getId_habitacion()%>"><%=tematicaEncontrada%> - Capacidad: <%=tipoEncontrada%> persona - Precio x Noche: $<%=precioEncontrada%></option>
                                                               <%
                                                                //Cargando Huespdes  a las option
                                                    ...
                                                    <div class="col-12 d-flex justify-content-end">
                                                         ...
                                                         <!--BOTON volver atras -->    
                                                         <button type="button" onclick="window.location='registroReservas.jsp';return false;" class="btn btn-danger d-block me-1 mb-1">Cancelar</button>     
