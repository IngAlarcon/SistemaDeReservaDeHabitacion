                            ...
                            <div class="col-12 col-md-6 order-md-2 order-first">
                                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Huespedes
                                        </li>    
                                    </ol>
                                </nav>
                            </div>
                           ...
                           <div class="col-md-6 col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">Editar datos de Huesped</h4>
                                </div>
                                <div class="card-content">
                                    ...
                                    Huesped editHuesped = (Huesped) misession.getAttribute("huespedEncontrado");
                                    

                                    String fechaString = control.convertirFechaStringInput(editHuesped.getFecha_nac());
                                              ...
                                              <form action="SvEditarHuesped" method="POST">  
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="nombreHuespedEditar" value="<%= editHuesped.getNombre() %>" placeholder="Nombre..." id="first-name-icon" required="">
                                                     ...
                                                     <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="apellidoHuespedEditar" value="<%= editHuesped.getApellido() %>" placeholder="Apellido...." id="first-name-icon" required="">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="dniHuespedEditar" value="<%= editHuesped.getDni() %>" placeholder="Ingrese su Dni..." id="first-name-icon" required="">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="date" class="form-control" name="fechaNacHuespedEditar" value="<%=fechaString%>" placeholder="" id="first-name-icon" required="">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            ...
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="direccionHuespedEditar" value="<%= editHuesped.getDireccion() %>" placeholder="Direccion..." id="first-name-icon" required="">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                     ...
                                                     <div class="col-12">
                                                        <div class="form-group has-icon-left">
                                                            <label for="first-name-icon">Profesion</label>
                                                            <div class="position-relative">
                                                                <input type="text" class="form-control" name="profesionHuespedEditar" value="<%= editHuesped.getProfesion() %>" placeholder="Profesion..." id="first-name-icon" required="">
                                                                <div class="form-control-icon">
                                                                    <i class="bi bi-pen"></i>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <input type="hidden" name="idEdit" value="<%=editHuesped.getId_persona()%>">
                                                  
                                                    <div class="col-12 d-flex justify-content-end">
                                                    
                                                    <!--BOTON volver atras -->    
                                                    <button type="button" onclick="window.location='registroHuespedes.jsp';return false;" class="btn btn-danger d-block me-1 mb-1">Cancelar</button>     
